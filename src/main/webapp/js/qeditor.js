    ...
    if (a === "createLink") {
      ...
      if (p.trim().length === 0) {
        ...
        input.onchange = function(){
            ...
            fd.append('file', file);
            $.ajax({
                    url : '../../action/article/saveArticleImg',
                    data : fd,
                    processData : false,  //告诉jquery 不要去处理发送的数据
                    contentType : false,  // 告诉jquery 不要去设计Content-Type 请求头
                    ...
                    success : function(data) {
                        console.log(data);
                        //let imgUrl = "http://localhost:8080/zhazha_forum/action/article/img/171204154333525";  window.location.pathname;
                        var imgUrl = "../../action/article/img/"+ data.split('.')[0] + "?formatImg=" + data.split('.')[1];
                        QEditor.imageChange(imgUrl);
