...
add_review.prototype = {
	...
	saveORUpdate : function() {
		 $("#savebutton").on('click',function(){
			 var data = $("#review_info_form").serializeObject();
			...
			add_review.prototype.ajax("POST", "json","application/x-www-form-urlencoded;charset=utf-8",data,url,success);
		 });
	},
