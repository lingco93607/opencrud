...
add_book.prototype = {
	...
	saveORUpdate : function() {
		 $("#savebutton").on('click',function(){
			 var data = $("#book_info_form").serializeObject();
			...
			add_book.prototype.ajax("POST", "json","application/x-www-form-urlencoded;charset=utf-8",data,url,success);
		 });
	},
