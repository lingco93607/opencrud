<html class="is-AppPromotionBarVisible cssanimations csstransforms csstransitions flexbox no-touchevents no-mobile" style="" lang="zh-CN"><head><script async="" src="https://ssl.google-analytics.com/ga.js"></script>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<meta http-equiv="X-ZA-Response-Id" content="108a900fb4ec4bcd">
<meta http-equiv="X-ZA-Experiment" content="default:None,ge3:ge3_10,ge2:ge2_1,nweb_sticky_sidebar:sticky,live_review_buy_bar:live_review_buy_bar_2,is_office:false,home_ui2:default,is_show_unicom_free_entry:unicom_free_entry_on,app_store_rate_dialog:close,qa_sticky_sidebar:sticky_sidebar,android_profile_panel:panel_a,live_store:ls_a2_b1_c1_f1,answer_related_readings:qa_recommend_with_ads_and_article,new_mobile_column_appheader:new_header,fav_act:default,remix_one_key_play_button:footerButton,mobile_qa_page_proxy_heifetz:m_qa_page_nweb,new_more:new,new_buy_bar:livenewbuy3,zcm-lighting:zcm,iOS_newest_version:4.2.0,qrcode_login:qrcode,wechat_share_modal:wechat_share_modal_show">
...
<meta id="znonce" name="znonce" content="adb3bdad30d8436cb756776aee16e141">
<!--[if lt IE 9]>
...
<input name="_xsrf" value="36336238346163612d336663652d343063322d393963652d646132373534363662636432" type="hidden">
...
<input name="password" aria-label="密码" placeholder="密码" required="" type="password"><button type="button" class="send-code-button">获取验证码</button>
</div>

<div class="Captcha input-wrapper" data-type="cn" data-za-module="Captcha">
<div class="Captcha-operate">
<input name="captcha" required="" data-rule-required="true" data-msg-required="请点击图中所有倒立的文字" value="" type="hidden">
<input name="captcha_type" value="cn" required="" type="hidden">
...
<div class="qrcode-signin-container" style="display: none;">
<div class="qrcode-signin-step1">
<div class="qrcode-signin-img-wrapper">
<img src="https://account.zhihu.com/api/login/qrcode/042JvbFGSG6l7Y5h/image" class="qrcode-signin-img">
</div>
...
<div class="qrcode-signin-step2" style="display: none;">
...
<div class="qrcode-signin-failure" style="display: none;">
...
<div class="qrcode-signin-guide" style="opacity: 0; left: -288px;"></div>
</div>
...
<form class="zu-side-login-box" action="/register/email" id="sign-form-1" autocomplete="off" method="POST" novalidate="novalidate">
...
<input required="" class="account" name="phone_num" aria-label="手机号" placeholder="手机号" type="text">

</div>
<div class="input-wrapper">
<input required="" name="password" aria-label="密码" placeholder="密码（不少于 6 位）" autocomplete="off" type="password">
</div>
...
<script type="text/json" class="json-inline" data-name="ga_vars">{"user_created":0,"now":1508901373000,"abtest_mask":"------------------------------","user_attr":[0,0,0,"-","-"],"user_hash":0}</script>
...
<script src="https://static.zhihu.com/static/revved/-/js/closure/common.58dc6307.js"></script>
...
<div id="zh-hovercard"></div><div id="zh-tooltip"></div><span><div><button data-zfeedback-ignore="true" class="FeedbackButton-button-3waL" title="建议反馈"><span class="FeedbackButton-icon-1Rgw"></span></button></div></span><script type="text/template" class="register-template">
...
<input type="text" name="phone_num" class="account" data-is-domestic="true" aria-label="手机号" placeholder="手机号" required>
...
<a class="blue-button blue-button--link" href="/account/appeal" target="_blank">人工申诉</a>
</div>
...
<a href="/signin" class="switch-to-login">使用已有帐号登录</a></span>
</div>
</form>
</div>
...
</script><div id="particles"><canvas class="particles-js-canvas-el" style="width: 100%; height: 100%;" width="1903" height="305"></canvas></div></body></html>