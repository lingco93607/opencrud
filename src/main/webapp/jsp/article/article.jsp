...
<script type="text/javascript"
	src="javascript/article/article.js"></script>
<script type="text/javascript" 
...
<div id="searcharticles">
	<form id="searchform" style="margin-left:0%;">
        <a>用户名称:</a>
		<input type="text" id="searchArticleName" class="searchplay" name="userName"/>
		<input type="button" id="searchbutton" value="查询"/>
        <input type="reset" id="searchreset" value="重置"/>
	</form>
</div>
    <!--加载Grid的DIV-->
	<div id="articleManagerGrid" class="yahei"></div>
	<!--end-->
	<!--新增修改页面的弹窗-->
	<div id="addUpdateWindowContainer" style="display: none;" class="yahei">
		<div id="addUpdateManagerWindow">
			...
			<div id="addUpdateManagerWindowContent" style="overflow: hidden;">
			   <form id="article_info_form" action="action/article/savearticle"
			enctype='multipart/form-data' method="post" style="font-family:microsoft yahei">
			<table>
				<tr>
<td align='right'><b style='color:red;'></b>path:</td>
<td align='right'><input id="path" name="path" class="rolestext" type="text" /></td></tr><tr>
...
<td align='right'><b style='color:red;'></b>voteNum:</td>
<td align='right'><input id="voteNum" name="voteNum" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>articleID:</td>
<td align='right'><input id="articleID" name="articleID" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>publishDate:</td>
<td align='right'><input id="publishDate" name="publishDate" class="rolestext" type="text" /></td></tr><tr>
...
<td align='right'><b style='color:red;'></b>type:</td>
<td align='right'><input id="type" name="type" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>title:</td>
<td align='right'><input id="title" name="title" class="rolestext" type="text" /></td></tr><tr>
