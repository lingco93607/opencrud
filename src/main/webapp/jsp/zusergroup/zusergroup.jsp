...
<script type="text/javascript"
	src="javascript/zusergroup/zusergroup.js"></script>
<script type="text/javascript" 
...
<body>
<div id="searchzusergroups">
	<form id="searchform" style="margin-left:0%;">
        <a>用户名称:</a>
		<input type="text" id="searchZUserGroupName" class="searchplay" name="userName"/>
		<input type="button" id="searchbutton" value="查询"/>
        <input type="reset" id="searchreset" value="重置"/>
	</form>
</div>
    <!--加载Grid的DIV-->
	<div id="zusergroupManagerGrid" class="yahei"></div>
	<!--end-->
	<!--新增修改页面的弹窗-->
	<div id="addUpdateWindowContainer" style="display: none;" class="yahei">
		<div id="addUpdateManagerWindow">
			...
			<div id="addUpdateManagerWindowContent" style="overflow: hidden;">
			   <form id="zusergroup_info_form" action="action/zusergroup/savezusergroup"
...
<td align='right'><b style='color:red;'></b>isAdministrator:</td>
<td align='right'><input id="isAdministrator" name="isAdministrator" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>isCreator:</td>
<td align='right'><input id="isCreator" name="isCreator" class="rolestext" type="text" /></td></tr>
