...
<script type="text/javascript"
	src="javascript/review/review.js"></script>
<script type="text/javascript" 
...
<div id="searchreviews">
	<form id="searchform" style="margin-left:0%;">
        <a>用户名称:</a>
		<input type="text" id="searchReviewName" class="searchplay" name="userName"/>
		<input type="button" id="searchbutton" value="查询"/>
        <input type="reset" id="searchreset" value="重置"/>
	</form>
</div>
    <!--加载Grid的DIV-->
	<div id="reviewManagerGrid" class="yahei"></div>
	<!--end-->
	<!--新增修改页面的弹窗-->
	<div id="addUpdateWindowContainer" style="display: none;" class="yahei">
		<div id="addUpdateManagerWindow">
			...
			<div id="addUpdateManagerWindowContent" style="overflow: hidden;">
			   <form id="review_info_form" action="action/review/savereview"
...
<td align='right'><b style='color:red;'></b>reviewID:</td>
<td align='right'><input id="reviewID" name="reviewID" class="rolestext" type="text" /></td></tr>
