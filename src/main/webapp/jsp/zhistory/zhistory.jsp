...
<script type="text/javascript"
	src="javascript/zhistory/zhistory.js"></script>
<script type="text/javascript" 
...
<body>
<div id="searchzhistorys">
	<form id="searchform" style="margin-left:0%;">
        <a>用户名称:</a>
		<input type="text" id="searchZHistoryName" class="searchplay" name="userName"/>
		<input type="button" id="searchbutton" value="查询"/>
        <input type="reset" id="searchreset" value="重置"/>
	</form>
</div>
    <!--加载Grid的DIV-->
	<div id="zhistoryManagerGrid" class="yahei"></div>
	<!--end-->
	<!--新增修改页面的弹窗-->
	<div id="addUpdateWindowContainer" style="display: none;" class="yahei">
		<div id="addUpdateManagerWindow">
			...
			<div id="addUpdateManagerWindowContent" style="overflow: hidden;">
			   <form id="zhistory_info_form" action="action/zhistory/savezhistory"
...
<td align='right'><b style='color:red;'></b>zLocation:</td>
<td align='right'><input id="zLocation" name="zLocation" class="rolestext" type="text" /></td></tr>
