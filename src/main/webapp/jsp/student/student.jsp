...
<script type="text/javascript"
	src="javascript/student/student.js"></script>
<script type="text/javascript" 
...
<body>
<div id="searchstudents">
	<form id="searchform" style="margin-left:0%;">
        <a>用户名称:</a>
		<input type="text" id="searchStudentName" class="searchplay" name="userName"/>
		<input type="button" id="searchbutton" value="查询"/>
        <input type="reset" id="searchreset" value="重置"/>
	</form>
</div>
    <!--加载Grid的DIV-->
	<div id="studentManagerGrid" class="yahei"></div>
	<!--end-->
	<!--新增修改页面的弹窗-->
	<div id="addUpdateWindowContainer" style="display: none;" class="yahei">
		<div id="addUpdateManagerWindow">
			...
			<div id="addUpdateManagerWindowContent" style="overflow: hidden;">
			   <form id="student_info_form" action="action/student/savestudent"
			enctype='multipart/form-data' method="post" style="font-family:microsoft yahei">
			<table>
				<tr>
<td align='right'><b style='color:red;'></b>sname:</td>
<td align='right'><input id="sname" name="sname" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>sex:</td>
<td align='right'><input id="sex" name="sex" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>sid:</td>
<td align='right'><input id="sid" name="sid" class="rolestext" type="text" /></td></tr><tr>
<td align='right'><b style='color:red;'></b>home:</td>
<td align='right'><input id="home" name="home" class="rolestext" type="text" /></td></tr>
